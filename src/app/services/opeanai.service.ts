...
//     // private apiUrl = 'http://localhost:8085/createimage'; // Local development URL
...
//      */
//     // Updates for src/app/services/opeanai.service.ts

//     // Updates to your processQueue method in openai.service.ts
...
//         // const prompt = `Create a professional cover image for an ESG Report titled "${companyName} ESG Report ${year}". The image should include symbolic representations of the environment, social justice, and governance using a clean, executive design aesthetic. Design specifications are Corporate-style infographic format Executive-friendly color palette (blues, greys, whites) Image resolution: 1024x1024, suitable for report inclusion`;


//         const prompt = `Professional cover image for "BATSAMAYI ESG Report 2025" with environmental, social, and governance symbols. Blue and grey corporate style.`;
